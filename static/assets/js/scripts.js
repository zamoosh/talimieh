...
!function (u, p) {
    ...
    var c = p(window), a = p("body"), l = p(document), t = "nk-menu", s = "nk-header-menu", r = "nk-sidebar",
        d = u.Break;
    ...
    u.ClassBody = function () {
        ...
        u.BreakClass("." + s, d.lg, {timeOut: 0}), c.on("resize", function () {
            u.BreakClass("." + s, d.lg)
        })
    }, u.Prettify = function () {
        ...
        var a = "info" === (e = e || "info") ? "ni ni-info-fill" : "success" === e ? "ni ni-check-circle-fill" : "error" === e ? "ni ni-cross-circle-fill" : "warning" === e ? "ni ni-alert-fill" : "",
            i = {position: "bottom-right", ui: "", icon: "auto", clear: !1}, i = n ? f(i, n) : i;
        ...
        var n = p(t || ".toggle"), o = p("[data-content]"), s = !1,
            t = {active: "active", content: "content-active", break: !0}, r = e ? f(t, e) : t;
        ...
        var n = t || ".expand", t = {toggle: !0}, a = e ? f(t, e) : t;
        p(n).on("click", function (t) {
            u.Toggle.trigger(p(this).data("target"), a), t.preventDefault()
        })
    }, u.TGL.ddmenu = function (t, e) {
        var n = t || ".nk-menu-toggle", t = {active: "active", self: "nk-menu-toggle", child: "nk-menu-sub"},
            a = e ? f(t, e) : t;
        p(n).on("click", function (t) {
        ...
        t.on("click", function (t) {
            t.preventDefault();
            var e = p(this), t = e.data("target"), t = p("[data-content=" + t + "]");
        ...
        p(a).exists() && p(a).each(function () {
            var t = (t = p(a).data("max-files")) || null, e = (e = p(a).data("max-file-size")) || 256,
                n = p(a).data("accepted-files"),
                n = {autoDiscover: !1, maxFiles: t, maxFilesize: e, acceptedFiles: n = n || null}, n = i ? f(n, i) : n;
        ...
        t.exists() && t.each(function () {
            ...
            a.steps({
                ...
                labels: {finish: "ارسال", next: "بعدی", previous: "قبلی", loading: "در حال پردازش ..."},
            ...
            var t = p(this).data("auto-responsive"), e = !(void 0 === o.buttons || !o.buttons),
                ...
                e = {
                    ...
                    language: {
                        ...
                        infoEmpty: "هیچ اطلاعاتی وجود ندارد !",
                        infoFiltered: "( Total _MAX_  )",
                        paginate: {first: "اولین", last: "آخرین", next: "بعدی", previous: "قبلی"}
                    }
                }, e = o ? f(e, o) : e, e = !1 === t ? f(e, {responsive: !1}) : e;
        ...
        p(t || ".dropdown-menu").on("click", function (t) {
            ...
            var t = p(this);
            t.hasClass("dropdown-menu-right") && !t.hasClass("dropdown-menu-center") ? t.prev('[data-toggle="dropdown"]').dropdown({popperConfig: {placement: "bottom-start"}}) : t.hasClass("dropdown-menu-right") || t.hasClass("dropdown-menu-center") || t.prev('[data-toggle="dropdown"]').dropdown({popperConfig: {placement: "bottom-end"}})
        })
        ...
        p(t).exists() && "undefined" != typeof noUiSlider && p(t).each(function () {
            var t = p(this), e = t.attr("id"), n = t.data("start"), n = (n = /\s/g.test(n) ? n.split(" ") : n) || 0,
                ...
                i = (i = t.data("min")) || 0, o = (o = t.data("max")) || 100, s = (s = t.data("min-distance")) || null,
                r = (r = t.data("max-distance")) || null, c = (c = t.data("step")) || 1,
                l = (l = t.data("orientation")) || "horizontal", t = (t = t.data("tooltip")) || !1;
            console.log(t);
        ...
        p(t).exists() && p(t).each(function () {
            ...
            } : {type: "image", mainClass: "mfp-fade images-popup"}, t = n ? f(t, n) : t;
        ...
        u.ClassBody(), u.PassSwitch(), u.CurrentLink(), u.LinkOff(".is-disable"), u.ClassNavMenu(), u.SetHW("[data-height]", "height"), u.SetHW("[data-width]", "width"), u.NumberSpinner(), u.Lightbox(".popup-video", "video"), u.Lightbox(".popup-iframe", "iframe"), u.Lightbox(".popup-images", "image"), u.Lightbox(".popup-content", "content"), u.Control(".custom-control-input")
    }, u.Ani.init = function () {
        u.Ani.formElm(".form-control-outlined"), u.Ani.formSearch(".toggle-search")
    }, u.BS.init = function () {
        u.BS.menutip("a.nk-menu-link"), u.BS.tooltip(".nk-tooltip"), u.BS.tooltip(".btn-tooltip", {placement: "top"}), u.BS.tooltip('[data-toggle="tooltip"]'), u.BS.tooltip(".tipinfo,.nk-menu-tooltip", {placement: "right"}), u.BS.popover('[data-toggle="popover"]'), u.BS.progress("[data-progress]"), u.BS.fileinput(".custom-file-input"), u.BS.modalfix(), u.BS.ddfix(), u.BS.tabfix()
