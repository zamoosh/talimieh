...
!function (NioApp, $) {
    ...
    function barChart(selector, set_data) {
        ...
        $selector.each(function () {
            ...
            var chart = new Chart(selectCanvas, {
                type: "bar", data: {labels: _get_data.labels, datasets: chart_data}, options: {
                    legend: {
    ...
    function lineChart(selector, set_data) {
        ...
        $selector.each(function () {
            ...
            var chart = new Chart(selectCanvas, {
                type: "line", data: {labels: _get_data.labels, datasets: chart_data}, options: {
                    legend: {
                        display: _get_data.legend || !1,
                        rtl: NioApp.State.isRTL,
    ...
    var doughnutChartData = {
        ...
        dataUnit: "BTC",
        legend: !1,
        datasets: [{borderColor: "#fff", background: ["#b695ff", "#f4aaa4", "#8feac5"], data: [5, 80, 125]}]
    };
